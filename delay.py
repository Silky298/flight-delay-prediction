...
def loadData():
    dtype_dict = {'TAIL_NUMBER': str, 'ORIGIN_AIRPORT': str}
    relevant_columns = ["MONTH", "DAY", "SCHEDULED_DEPARTURE", "DEPARTURE_DELAY", "AIRLINE", "ORIGIN_AIRPORT",
                        "DESTINATION_AIRPORT", "DAY_OF_WEEK"]
    flights = pd.read_csv('flights.csv', usecols=relevant_columns, dtype=dtype_dict, low_memory=False)
